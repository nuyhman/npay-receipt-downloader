...
<p align="center">
    <img src="screenshots/popup-step1.png" width="320" alt="1단계: 달을 고르고 결제내역 열기" />
    <img src="screenshots/popup-step2.png" width="320" alt="2단계: 저장 방식을 고르고 영수증 받기" />
</p>
...
1. 크롬 확장 프로그램 아이콘을 클릭합니다. (1단계)
2. 조회할 월을 선택하고 "N월 결제내역 열기" 버튼을 클릭합니다.
3. 결제내역 페이지가 열리면 아이콘을 다시 클릭합니다. (2단계로 넘어갑니다)
4. 저장 방식(한 번에 저장 / 하나씩 저장)을 선택합니다.
